...
// RoleEnum * `voter` - voter * `witness` - witness * `observer` - observer
type RoleEnum string

// List of RoleEnum
const (
	ROLEENUM_VOTER    RoleEnum = "voter"
	ROLEENUM_WITNESS  RoleEnum = "witness"
	ROLEENUM_OBSERVER RoleEnum = "observer"
)
